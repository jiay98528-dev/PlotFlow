...
export const officialThemes = {
  ...
  en: {
    ...
    note: 'All three themes ship with the app and can be switched in Theme Center.',
    items: [
      {
        id: 'plotflow-prism-foundry',
        name: 'Prism Foundry',
...
export const developmentCopy = {
  ...
  en: {
    ...
    sourceNote: 'Current development baseline and upcoming work.',
