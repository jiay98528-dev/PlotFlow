...
|---|---|---|
| Integration E2E | Passed | 74/74 on the current ADR-013 source revision, including typed literal-left conditions, three-level AND/OR/NOT, six variable types, chapter scope, engine metadata, Inspector rejection, history and accessibility. |
...
| Unpacked blackbox | Passed | Fresh `package:win` followed by 16 passed / 1 installed-only skip. The strict native Graph-first journey exported Schema 0.2 and validated the disk JSON with Ajv draft-2020-12. |
