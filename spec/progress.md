...
| M1 | 核心解析与编辑 | 17 | 8 | 0 | 9 | 0 | 47% |
| M2 | 分支可视化 | 16 | 7 | 0 | 9 | 0 | 44% |
| M3 | 条件编辑与错误检测 | 18 | 9 | 0 | 9 | 0 | 50% |
| M4 | 导出系统 | 26 | 12 | 0 | 0 | 14 | 46% |
| M5 | 补全引擎 | 19 | 6 | 0 | 1 | 12 | 32% |
| M6 | 模板与主题 | 18 | 18 | 0 | 0 | 0 | 100% |
| M7 | Electron 打包发布 | 15 | 0 | 0 | 5 | 10 | 0% |
| **合计** | | **142** | **73** | **0** | **33** | **36** | **51%** |
...
| M5-08 | GhostTextPlugin（Monaco 扩展） | ⏭️ | — | — | 延后至 V0.2 |
| M5-09 | 四维触发检测 | ⏭️ | — | — | 延后至 V0.2 |
| M5-10 | 幽灵字符渲染逻辑 | ⏭️ | — | — | 延后至 V0.2 |
| M5-11 | Tab 接受 / Esc 忽略 / 输入覆盖 | ⏭️ | — | — | 延后至 V0.2 |
| M5-12 | Ctrl+Space 多候选下拉菜单 | ⏭️ | — | — | 延后至 V0.2 |
| M5-13 | 频率控制（<100ms 不触发） | ⏭️ | — | — | 延后至 V0.2 |
...
| M7-02 | Windows 构建（.exe + .msi） | ⏭️ | — | — | 延后至 V0.2 |
| M7-03 | macOS 构建（.dmg） | ⏭️ | — | — | 延后至 V0.2 |
| M7-04 | Linux 构建（.AppImage + .deb） | ⏭️ | — | — | 延后至 V0.2 |
| M7-05 | 应用图标 | ⬜ | — | — | |
| M7-06 | 应用信息 | ⏭️ | — | — | 延后至 V0.2 |
| M7-07 | .mdstory 文件关联 | ⬜ | — | — | |
| M7-08 | 双击 .mdstory → 应用打开 | ⬜ | — | — | |
| M7-09 | electron-updater 集成 | ⏭️ | — | — | 延后至 V0.2 |
| M7-10 | 更新服务器配置 | ⏭️ | — | — | 延后至 V0.2 |
| M7-11 | CHANGELOG.md | ⬜ | — | — | |
| M7-12 | GitHub Release 草稿 | ⏭️ | — | — | 延后至 V0.2 |
| M7-13 | 安装后首次启动引导 | ⏭️ | — | — | 延后至 V0.2 |
| M7-14 | Windows 安装包冒烟测试 | ⏭️ | — | — | 延后至 V0.2 |
| M7-15 | macOS/Linux 基础冒烟测试 | ⏭️ | — | — | 延后至 V0.2 |
